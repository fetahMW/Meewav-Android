...
Correction finale demandée : **la parole est audio seulement, dans la Place ET dans la Classe**. `grantAudioFloor` active le micro et sélectionne le fader, sans toucher aux positions des invités, à la composition vidéo ou au flux principal. `releaseAudioFloor` coupe le micro, sans descendre une personne déjà sur scène. La capacité vidéo ne limite pas la parole. Le mixeur peut afficher l’orateur en coulisses uniquement lorsqu’il possède ce droit audio explicite. La synchronisation ne considère plus « pas sur scène » comme une perte de parole. La restauration ne réactive pas un micro. Clash et Défis restent inchangés. Quatorze tests ciblés passent ; aucun test RTC distant n’est revendiqué.
