...
Avant le rétablissement des réglages Web, le bundle avait été construit, `assembleDebug` avait réussi et l’APK avait été installé sur le S22 Ultra. L’arrivée paysage sur fond acoustique et le moteur complet avec étoiles, vinyle, portraits et palette territoriale avaient été observés sur le téléphone. Canvas 797 × 384 CSS ; aucune ressource distante ni erreur HTTP relevée, contexte WebGL actif sans erreur. Ces observations ne valident pas le rendu ou la fluidité après le rétablissement du 15 septembre. Aucun nouvel essai visuel ni relevé de performances n’est prévu pour cette restauration. L’inscription réelle, les services, les Rooms et les lives ne sont pas validés ici.

Après restauration : bundle reconstruit, `:app:assembleDebug` réussi, APK installé et application relancée sur le S22 Ultra. Aucun test applicatif, contrôle visuel ou relevé FPS supplémentaire n’a été effectué.
