...
Correction suivante : le bloc « Localisation respectueuse » et son récapitulatif après sélection sont retirés. Localisation devient fixe, sans défilement de la page ni de la vitre. Les espacements du formulaire et du séparateur supérieur sont resserrés ; le toggle suit directement les deux sélecteurs, avec la phrase courte « Ton adresse reste privée. ». Terminer reste dans le pied. Les panneaux de recherche de commune et de quartier conservent leur propre liste défilante.

Après signalement utilisateur d’une zone de globe vide, le chargement Android est remplacé par un document HTML autonome fourni directement à la WebView. La carte terrestre, le renderer et le style sont intégrés à la construction, avec la même géométrie et les mêmes matériaux issus du Web. La vue native occupe explicitement toute sa zone, son redimensionnement réveille le rendu et les erreurs de chargement principales sont remontées. Les textes de fin et la navigation restent inchangés. Ce correctif de chargement n’est pas une validation visuelle sur téléphone.

## Deux projecteurs arrière et allumage progressif — 14 septembre 2026

Sur demande utilisateur et d’après sa capture iOS, les deux spots avant sont retirés du plateau partagé de Connexion et Avatar. Les deux corps arrière restent fixes. Leurs lentilles blanches éclairent deux zones diffuses sur le mur ; une brume légère aux contours flous remplace les triangles violets. Seuls les faisceaux oscillent discrètement, avec un déphasage. Les halos sont calculés en textures mises en cache, sans flou recalculé à chaque image.

À l’arrivée d’un avatar, le contour du plateau s’allume immédiatement, puis le projecteur gauche après 75 ms, puis le droit après 150 ms ; l’ensemble atteint son intensité en 330 ms. Durant le défilement, l’éclairage baisse en 100 ms. Chaque nouveau geste ou sélection annule la séquence précédente : pas d’allumages mis en file ni d’impulsion supplémentaire. La sélection par vignettes reprend aussi cette séquence. L’impulsion de confirmation, les avatars et la disposition de la fenêtre sont conservés. Connexion conserve ses lumières allumées et la simple lévitation du MW. Aucun test applicatif ni contrôle visuel automatique réalisé.
...
Dernière direction sur Bienvenue : le MW remonte de 6 dp par rapport au réglage précédent. Quatre spots sont rallumés, deux blancs à l’arrière et deux violets à l’avant de l’ellipse. Ils arrivent progressivement en 360 ms. Leurs faisceaux diffus décrivent de petites ellipses sur 16 secondes, avec phases et sens distincts pour éviter un balayage synchronisé ; les points d’émission et les corps restent fixés au plateau. La signature garde uniquement sa lévitation. Ce mode à quatre spots est réservé à Bienvenue : la séquence d’allumage d’Avatar, le cadre stable au clavier et le bypass sont conservés. Aucun contrôle visuel ni scénario automatique exécuté.

Les deux signatures MW sont ensuite légèrement éclaircies, de `#5137A1` à `#6046B3`, sur le podium et dans le logo supérieur. Le lettrage blanc Meewav et les couleurs des CTA ne changent pas.

Sur Bienvenue uniquement, les blancs sont rapprochés sous le MW (24 unités de chaque côté du centre du plateau) et orientés vers l’extérieur pour croiser les violets, légèrement écartés à 54 unités. Les cônes blancs sont raccourcis de 130 à 90 unités au maximum et leurs reflets muraux réduits. Les corps, lentilles et pivots partagent ces positions ; seuls les faisceaux conservent leur mouvement. La géométrie et la séquence lumineuse de la deuxième page Avatar restent inchangées. Aucun contrôle visuel automatique réalisé.

Après retour utilisateur sur des blancs tordus, Bienvenue utilise désormais des cônes rectilignes : ouverture régulière autour de l’axe lentille-cible, bords légèrement diffus et extinction progressive vers la pointe éloignée. Les taches ovales séparées sont retirées et le mouvement blanc devient une rotation rigide autour de la lentille, sans étirement. Les positions rapprochées, la hauteur réduite et les violets restent en place. Le rendu de la page Avatar conserve son tracé antérieur. Rendu à apprécier par l’utilisateur, sans inspection visuelle automatique.

À la demande suivante, les blancs de Bienvenue sont écartés jusqu’aux bords du plateau (64 unités de part et d’autre du centre), avec une visée de 28 unités vers l’extérieur. La lumière blanche retrouve une projection diffuse sur le mur, alignée sur le faisceau, et des bords largement floutés. Le cône rectiligne s’évase davantage et sa hauteur maximale passe à 106 unités. Les violets et la deuxième page restent inchangés. Aucun contrôle visuel automatique.

Direction retenue ensuite : Bienvenue reprend directement le mode standard du plateau utilisé par Avatar, avec la même disposition des deux spots arrière et le même balayage violet sur 16 secondes. Les blancs sont éteints (intensité nulle), les violets atteignent la même intensité de 0,85 qu’Avatar et le plateau atteint son éclairage normal. L’ancien mode à quatre spots propre à Bienvenue n’est plus utilisé par cet écran. Seul l’appel de Bienvenue est modifié ; la mécanique de sélection et d’allumage d’Avatar reste intacte, ainsi que la lévitation du MW. Aucun contrôle visuel automatique.

Sur précision utilisateur, les cônes violets de Bienvenue visent désormais chacun vers l’extérieur (48 unités au-delà de leur propre spot), sans convergence centrale ni croisement. Les deux spots, la hauteur, le flou et le balayage restent ceux du mode Avatar. Cette orientation est activée uniquement dans Bienvenue ; Avatar conserve ses faisceaux croisés et sa séquence. Les blancs de Bienvenue restent éteints. Aucun contrôle visuel automatique.
...
## Chargement du globe de fin — 14 septembre 2026

La capture utilisateur montrait une page Web refusée par le propre filtre de ressources Android : le document et la carte intégrés en URL data étaient incompatibles avec la liste autorisée. Le globe final Three.js du Web est conservé (vinyle, shader de reflets, palette et rotation). Le HTML, le JavaScript, le CSS et la texture sont maintenant servis depuis l’APK sous une origine locale explicite, sans requête au site Web. La miniature n’est révélée et son clic activé qu’après le premier rendu avec la carte ; l’erreur du navigateur est masquée au profit d’un message natif et de Réessayer. Le cycle de vie, les gestes du visualiseur local et la navigation native restent en place. Le globe SwiftUI de l’iOS a été comparé : il n’offre pas les finitions du globe Web et n’est pas substitué à ce dernier. Voir les sources et le chargement dans [le guide du globe embarqué](../../app/src/main/globe-source/README.md). Aucun scénario, test ou contrôle visuel automatique réalisé.

À la demande de l’utilisateur, l’entrée dans Mon Globe impose le paysage sur téléphone, dans les deux sens horizontaux, avec barres système masquées et rappelables par balayage. L’en-tête compact est superposé à la scène pour laisser tout l’espace au globe ; le cadrage du visualiseur est rapproché. L’inscription et la miniature de fin restent en portrait, et Retour rétablit portrait et barres système. L’orientation est pilotée depuis MainActivity selon la page du ViewModel, conservée lors de la recréation Android, sans restauration contradictoire à la destruction de la composition. L’état des services et du globe produit reste distinct de ce visualiseur local.

Livraison de ce correctif : bundle Web reconstruit puis compilation Android assembleDebug réussie. Les licences, textures, palettes et shaders d’origine sont conservés ; aucune modification du dépôt Web ou de l’iOS. Le rendu et le parcours sur téléphone restent à confirmer par l’utilisateur.

## Clavier de Compte et maintien du bypass — 14 septembre 2026

Compte utilise désormais une disposition dédiée, calquée sur la gestion du clavier de Bienvenue : la hauteur du cadre est calculée hors IME et reste fixe. Sa position et la zone intérieure visible suivent les insets animés du clavier, sans redimensionner ni redessiner le contour violet à chaque image. Le logo et les étapes s’estompent progressivement ; le bouton Suivant garde sa taille et reste dans la zone visible. Le formulaire défile uniquement pendant la saisie, sans indicateur vertical. Les quatre champs conservent leur mécanisme natif de remise en visibilité ; la touche Suivant enchaîne explicitement e-mail, nom d’utilisateur, mot de passe puis confirmation, dont la touche finale soumet l’étape. L’enveloppe, les champs, le titre et l’avatar posé sur Apple sont conservés au repos. Le code de Bienvenue et d’Avatar n’est pas modifié.

Le retour de l’aperçu à Bienvenue réinitialisait auparavant `localPreview` à faux et réactivait les validations réelles. Ce retour conserve maintenant `BuildConfig.DEBUG` comme valeur du bypass : dans la build de travail, Connexion puis Suivant/Terminer permettent de parcourir les étapes sans remplir les champs, y compris après un retour en arrière. Les builds de production conservent leur authentification réelle. Compilation `assembleDebug` réussie ; aucun test applicatif ni scénario ou contrôle visuel automatique exécuté. Le rendu du clavier reste à apprécier sur l’appareil, et le signalement du globe invisible demeure distinct de cette correction.

Sur Bienvenue uniquement, les deux cônes violets sont rapprochés du MW de 12 unités chacun dans le repère de largeur 375. Les points d’émission et leurs pivots accompagnent cette translation horizontale ; l’inclinaison vers l’extérieur, la hauteur, le flou et le balayage restent identiques. Le réglage vaut zéro par défaut et la page Avatar conserve sa disposition.

## Diagnostic du globe vide sur appareil — 14 septembre 2026

À la demande explicite de l’utilisateur, le rendu a été inspecté sur le S22 Ultra. Le canvas avait une hauteur CSS nulle, même si les fichiers étaient chargés et WebGL disponible. Le lecteur fixe maintenant ses paramètres de taille sur le conteneur Android, ancre le canvas au viewport et attend une surface visible avant d’annoncer « prêt ». Après réinstallation, miniature, passage en paysage, rendu animé et glisser ont été observés sur le téléphone ; le bypass a permis de traverser les quatre étapes sans saisie. Les mesures et limites des contrôles sont consignées dans [le guide du globe embarqué](../../app/src/main/globe-source/README.md). Le correctif révèle le visualiseur existant ; l’audit et le portage du globe complet du Web, avec sa skybox et son cadrage, font l’objet de la demande suivante.
