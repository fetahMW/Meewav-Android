...
| A01 | Création/connexion réelle → globe → retours des features | Route réelle ajoutée ; atelier démo conservé, entrée recette LIVE_AUTH | APK installé Samsung | Compilation + tests unitaires passent ; Samsung verrouillé, recette UI en attente |
