            ...
            override fun shouldOverrideUrlLoading(view: WebView, request: WebResourceRequest): Boolean {
                ...
                if (assetSurface == "rooms" && request.isForMainFrame && request.method == "GET"
                    ...
                    if (room != null) startActivity(Intent(this@MessagingActivity, com.meewav.android.features.rooms.wave.WaveMixerActivity::class.java)
                        ...
                        .putExtra("launchFormat", request.url.getQueryParameter("format")?.takeIf { it in setOf("portrait", "landscape") } ?: "landscape")
                        .putExtra("launchCamera", request.url.getQueryParameter("camera")?.takeIf { it in setOf("front", "back") } ?: "front")
                        .putExtra("launchLayout", request.url.getQueryParameter("layout")?.take(32))
                        .putExtra("launchSecondCamera", request.url.getQueryParameter("secondCamera") == "true")
