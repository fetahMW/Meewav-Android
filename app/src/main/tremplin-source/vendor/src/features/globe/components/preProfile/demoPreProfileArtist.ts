...
export const DEMO_PREPROFILE_AUDIOS: PreProfileDemoArtist["audios"] = [
  {
    id: "tech-house-vibes",
    mediaUrl: new URL("media/preprofile-demo/tech-house-vibes.mp3", document.baseURI).href,
  ...
  {
    id: "hazy-after-hours",
    mediaUrl: new URL("media/preprofile-demo/hazy-after-hours.mp3", document.baseURI).href,
...
const PREPROFILE_PORTRAIT_URLS = Array.from({ length: 38 }, (_, index) =>
  new URL(`images/preprofile/portraits/profile-${String(index + 1).padStart(2, "0")}.webp`, document.baseURI).href,
);
const FOUNDER_HOST_PORTRAIT_URL = new URL(
  "assets/orbit/founder-puff.png",
  document.baseURI,
).href;
